...
This one-time setup will get you up and running with Quinfer.

## Step 1: Activate Your License
The first time you open Quinfer, you will be prompted to enter your license key.
...
For enhanced security, Quinfer requires you to set up a password to protect your local data. This ensures that only you can access your assessments, student responses, and analysis results.

The first time you launch Quinfer after activating your license, you will be guided through the password creation process.
...
> **Important:** Your password only protects the data on your local device. It is not stored online and cannot be recovered by Quinfer support if you lose both your password and your license key.

## Step 3: Get Your Google AI API Key
Quinfer uses Google's powerful Gemini models to generate high-quality assessment content. To use this feature, you need an API key from Google AI Studio. Your key is encrypted and stored securely and locally on your device.
...
## Step 4: Configure Quinfer Settings
Now, let's add your new API key to Quinfer.

1.  **Navigate to Settings:** In the Quinfer app, click on the **Settings** icon in the application header or the left-hand sidebar.
